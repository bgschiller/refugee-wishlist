...
/***/ function(module, exports, __webpack_require__) {
	...
	window.wishes = (0, _api2.default)();
	window.app = new _app2.default({
	  collection: wishes
	});

	(0, _jquery2.default)('.app-target').html(app.render().el);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wishlist = __webpack_require__(6);
	...
	exports.default = _backbone2.default.View.extend({
	  initialize: function initialize() {
	    this.wishlist = new _wishlist2.default({ collection: this.collection });
	  },
	  render: function render() {
	    this.$el.html((0, _app2.default)({ collection: this.collection.toJSON() }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wishCard = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wishCard = __webpack_require__(8);
	...
	exports.default = _backbone2.default.View.extend({
	  ...
	  render: function render() {
	    this.$el.html((0, _wishCard2.default)(this.model.toJSON()));
